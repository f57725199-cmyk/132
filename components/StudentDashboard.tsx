                  ...
                  <div className="space-y-4 mb-6">
                      ...
                      <div>
                          <div className="flex items-center justify-between px-2 mb-3">
                              ...
                              <button 
                                  onClick={() => alert("Detailed Features List:\n\n1. Video Lectures\n2. PDF Notes\n3. MCQ Practice\n4. Weekly Tests\n5. Live Chat\n6. Leaderboard\n7. Games\n8. Rewards\n9. Progress Tracking\n10. Admin Support\n...and 100+ more!")}
                          ...
                          <div className="grid grid-cols-4 gap-3 px-1">
                              <button onClick={() => onTabChange('VIDEO')} className="aspect-square bg-white rounded-2xl border border-slate-100 shadow-sm flex flex-col items-center justify-center gap-1 hover:shadow-md hover:scale-105 transition-all group">
                                  ...
                                  <span className="text-[10px] font-bold text-slate-600">Videos</span>
                              </button>
                              <button onClick={() => onTabChange('PDF')} className="aspect-square bg-white rounded-2xl border border-slate-100 shadow-sm flex flex-col items-center justify-center gap-1 hover:shadow-md hover:scale-105 transition-all group">
                                  <div className="w-10 h-10 bg-blue-50 rounded-full flex items-center justify-center text-blue-500 group-hover:bg-blue-500 group-hover:text-white transition-colors">
                                      <FileText size={20} />
                                  </div>
                                  <span className="text-[10px] font-bold text-slate-600">PDFs</span>
                              </button>
                              <button onClick={() => onTabChange('MCQ')} className="aspect-square bg-white rounded-2xl border border-slate-100 shadow-sm flex flex-col items-center justify-center gap-1 hover:shadow-md hover:scale-105 transition-all group">
                                  ...
                                  <span className="text-[10px] font-bold text-slate-600">Tests</span>
                              </button>
                              <button onClick={() => onTabChange('STORE')} className="aspect-square bg-white rounded-2xl border border-slate-100 shadow-sm flex flex-col items-center justify-center gap-1 hover:shadow-md hover:scale-105 transition-all group">
                                  <div className="w-10 h-10 bg-yellow-50 rounded-full flex items-center justify-center text-yellow-500 group-hover:bg-yellow-500 group-hover:text-white transition-colors">
                                      <Crown size={20} />
                                  </div>
